...
split = 'test'  # 'train', 'valid', 'test' で切り替え
data_dir = os.path.join(data_root, f'{split}_cifar10')
...
save_dir = '/Users/konishi/PhotnicEncoder/dataloader/samples/cinic10_data/cifar-10_main'
